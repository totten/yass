 ...
 */
class YASS_Filter_FlexFK extends YASS_Filter {
     ...
     *  - fkTypeField: string, the column which names the type of entity
    ...
    function toLocal(&$entities, YASS_Replica $to) {
        ...
        $fkTypeField = $this->spec['fkTypeField'];
